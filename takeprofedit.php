...
if ($chpassword != "") {
  ...
  $passhash = md5($sec . $chpassword . $sec);
    ...
    update_phpBB2userPassword($CURUSER["username"],md5($chpassword));
    login_phpBB2user($CURUSER["username"], md5($chpassword), TRUE);
}
...
if (is_valid_id($stylesheet))
{
	update_phpBB2style ($CURUSER["username"],$stylesheet);
}
