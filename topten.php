...
<?
    ...
    while ($a = mysql_fetch_assoc($res))
    {
      ...
      if ($a["downloaded"])
      {
        ...
        $ratio = "Inf.";
      print("<tr$highlight><td class=\"rowhead\" align=\"center\">$num</td><td class=\"rowhead\" align=\"left\" $highlight><a href=\"userdetails.php?id=" .
...
<?
    ...
    while ($a = mysql_fetch_assoc($res))
    {
      ...
      if ($a["leechers"])
      {
        ...
        $ratio = "Inf.";
      print("<tr><td class=\"rowhead\" align=\"center\">$num</td><td class=\"rowhead\" align=\"left\"><a href=\"details.php?id=" . $a["id"] . "&amp;hit=1\"><b>" .
        $a["name"] . "</b></a></td><td class=\"rowhead\" align=right>" . number_format($a["times_completed"]) .
				"</td><td class=\"rowhead\" align=\"right\">" . mksize($a["data"]) . "</td><td class=\"rowhead\" align=\"right\">" . number_format($a["seeders"]) .
...
<?
  	$num = 0;
	    ...
	    print("<tr><td class=\"rowhead\" align=\"center\">$num</td><td class=\"rowhead\" align=\"left\"><table border=\"0\" class=\"main\" cellspacing=\"0\" cellpadding=\"0\"><tr><td class=\"embedded\">".
	      "<img align=\"middle\" src=\"pic/flag/$a[flagpic]\" alt=\"\" /></td><td class=\"embedded\"><b>$a[name]</b></td>".
	      "</tr></table></td><td class=\"rowhead\" align=\"right\">$value</td></tr>\n");
	  }
    end_table();
    end_frame();
  }
  ...
  function peerstable($res, $frame_caption)
  {
    ...
    begin_table();
		...
		{
      $highlight = $CURUSER["id"] == $arr["userid"] ? "" : "";
...
//				peerstable($r, "Top $limit Fastest Downloaders (timeout corrected)" . ($limit == 10 && $pu ? " <font class=small> - [<a href=topten.php?type=4&amp;lim=100&amp;subtype=dl>Top 100</a>] - [<a href=topten.php?type=4&amp;lim=250&amp;subtype=dl>Top 250</a>]</font>" : ""));
  ...
  end_main_frame();
  print("<p><font class=\"small\">Started recording account xfer stats on xxxx-xx-xx</font></p>");
  stdfoot();
?>
