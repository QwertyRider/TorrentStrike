		...
		<tr> 
		  <td colspan="3" width="175" class="row2">
			<table cellspacing="1" cellpadding="1" border="0">
			  <tr> 
				<td bgcolor="{T_TD_COLOR2}"><img src="{PHPURL}templates/iCGstation/images/spacer.gif" width="{INBOX_LIMIT_IMG_WIDTH}" height="8" alt="{INBOX_LIMIT_PERCENT}" /></td>
			  </tr>
			</table>
		  </td>
		</tr>
...
<br />
  ...
  <table border="0" cellpadding="3" cellspacing="1" width="100%" class="forumline">
	...
	<!-- BEGIN listrow -->
	<tr> 
	  <td class="{listrow.ROW_CLASS}" width="5%" align="center" valign="middle"><img src="{PHPURL}{listrow.PRIVMSG_FOLDER_IMG}" width="19" height="18" alt="{listrow.L_PRIVMSG_FOLDER_ALT}" title="{listrow.L_PRIVMSG_FOLDER_ALT}" /></td>
	...
	<tr> 
	  <td class="cat" colspan="5" height="28" align="right"> {S_HIDDEN_FIELDS} 
