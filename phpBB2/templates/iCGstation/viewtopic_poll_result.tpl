			...
			<tr> 
			  ...
			  <td> 
				<table cellspacing="0" cellpadding="0" border="0">
				  <tr> 
					<td><img src="{PHPURL}templates/iCGstation/images/vote_lcap.gif" alt="" height="12" /></td>
					...
					<td><img src="{PHPURL}templates/iCGstation/images/vote_rcap.gif" alt="" height="12" /></td>
				  </tr>
				</table>
			  </td>
