...
<table width="100%" cellpadding="4" cellspacing="1" border="0" align="center">
  <tr> 
	<td align="center" ><a href="{U_FORUM_INDEX}" target="_parent"><img src="../templates/iCGstation/images/logo_phpBB_med.gif" border="0" /></a></td>
  </tr>
  <tr> 
	<td align="center" > 
	  <table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
		...
		<!-- BEGIN catrow -->
		<tr> 
		  <td height="28" class="cat"><span class="cattitle">{catrow.ADMIN_CATEGORY}</span></td>
		</tr>
		<!-- BEGIN modulerow -->
		<tr> 
