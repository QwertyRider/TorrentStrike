...
while ( $row = $db->sql_fetchrow($result) )
{
	...
	if ( $view_online )
	{
		if ( $row['session_page'] < 1 || !$is_auth_ary[$row['session_page']]['auth_view'] )
		{
			switch( $row['session_page'] )
			{
				...
				case PAGE_SEARCH:
					...
					$location_url = basefile . "page=search";
				...
				case PAGE_VIEWONLINE:
					...
					$location_url = basefile . "page=viewonline";
					break;
				case PAGE_VIEWMEMBERS:
					$location = $lang['Viewing_member_list'];
					//$location_url = "memberlist.$phpEx";
					$location_url = basefile . "page=memberlist";
					break;
				case PAGE_PRIVMSGS:
					$location = $lang['Viewing_priv_msgs'];
					//$location_url = "privmsg.$phpEx";
					$location_url = basefile . "page=privmsg";
					break;
				case PAGE_FAQ:
					$location = $lang['Viewing_FAQ'];
					//$location_url = "faq.$phpEx";
					$location_url = basefile . "page=faq";
					break;
				default:
					$location = $lang['Forum_index'];
					//$location_url = "index.$phpEx";
		...
		else
		{
			...
			$location_url = append_sid(basefile . "page=viewforum&" . POST_FORUM_URL . '=' . $row['session_page']);
		...
		$template->assign_block_vars("$which_row", array(
			...
			'U_USER_PROFILE' => append_sid(basefile . "page=profile&mode=viewprofile&amp;" . POST_USERS_URL . '=' . $user_id),
