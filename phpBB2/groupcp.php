...
{
	global $lang, $images, $board_config, $phpEx, $phpBB2_install_url;
	...
	if ( $row['user_avatar_type'] && $row['user_id'] != ANONYMOUS && $row['user_allowavatar'] )
	{
		switch( $row['user_avatar_type'] )
		{
			case USER_AVATAR_UPLOAD:
				$poster_avatar = ( $phpBB2_install_url . $board_config['allow_avatar_upload'] ) ? '<img src="' . $phpBB2_install_url . $board_config['avatar_path'] . '/' . $row['user_avatar'] . '" alt="" border="0" />' : '';
				break;
			case USER_AVATAR_REMOTE:
				$poster_avatar = ( $phpBB2_install_url . $board_config['allow_avatar_remote'] ) ? '<img src="' . $phpBB2_install_url . $row['user_avatar'] . '" alt="" border="0" />' : '';
				break;
			case USER_AVATAR_GALLERY:
				$poster_avatar = ( $phpBB2_install_url . $board_config['allow_avatar_local'] ) ? '<img src="' . $phpBB2_install_url . $board_config['avatar_gallery_path'] . '/' . $row['user_avatar'] . '" alt="" border="0" />' : '';
				break;
		}
	}
	...
	{
		$email_uri = ( $board_config['board_email_form'] ) ? append_sid(basefile . "page=profile&mode=email&amp;" . POST_USERS_URL .'=' . $row['user_id']) : 'mailto:' . $row['user_email'];
	...
	$temp_url = append_sid(basefile . "page=profile&mode=viewprofile&amp;" . POST_USERS_URL . "=" . $row['user_id']);
	...
	$temp_url = append_sid(basefile . "page=privmsg&mode=post&amp;" . POST_USERS_URL . "=" . $row['user_id']);
	...
	$www_img = ( $row['user_website'] ) ? '<a href="' . $row['user_website'] . '" target="_userwww"><img src="' . $phpBB2_install_url . $images['icon_www'] . '" alt="' . $lang['Visit_website'] . '" title="' . $lang['Visit_website'] . '" border="0" /></a>' : '';
	$www = ( $row['user_website'] ) ? '<a href="' . $row['user_website'] . '" target="_userwww">' . $lang['Visit_website'] . '</a>' : '';

	if ( !empty($row['user_icq']) )
	{
		$icq_status_img = '<a href="http://wwp.icq.com/' . $row['user_icq'] . '#pager"><img src="http://web.icq.com/whitepages/online?icq=' . $row['user_icq'] . '&img=5" width="18" height="18" border="0" /></a>';
		$icq_img = '<a href="http://wwp.icq.com/scripts/search.dll?to=' . $row['user_icq'] . '"><img src="' . $phpBB2_install_url . $images['icon_icq'] . '" alt="' . $lang['ICQ'] . '" title="' . $lang['ICQ'] . '" border="0" /></a>';
	...
	$aim_img = ( $row['user_aim'] ) ? '<a href="aim:goim?screenname=' . $row['user_aim'] . '&amp;message=Hello+Are+you+there?"><img src="' . $phpBB2_install_url . $images['icon_aim'] . '" alt="' . $lang['AIM'] . '" title="' . $lang['AIM'] . '" border="0" /></a>' : '';
	$aim = ( $row['user_aim'] ) ? '<a href="aim:goim?screenname=' . $row['user_aim'] . '&amp;message=Hello+Are+you+there?">' . $lang['AIM'] . '</a>' : '';

	$temp_url = append_sid(basefile . "page=profile&mode=viewprofile&amp;" . POST_USERS_URL . "=" . $row['user_id']);
	$msn_img = ( $row['user_msnm'] ) ? '<a href="' . $temp_url . '"><img src="' . $phpBB2_install_url . $images['icon_msnm'] . '" alt="' . $lang['MSNM'] . '" title="' . $lang['MSNM'] . '" border="0" /></a>' : '';
	$msn = ( $row['user_msnm'] ) ? '<a href="' . $temp_url . '">' . $lang['MSNM'] . '</a>' : '';

	$yim_img = ( $row['user_yim'] ) ? '<a href="http://edit.yahoo.com/config/send_webmesg?.target=' . $row['user_yim'] . '&amp;.src=pg"><img src="' . $phpBB2_install_url . $images['icon_yim'] . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
	$yim = ( $row['user_yim'] ) ? '<a href="http://edit.yahoo.com/config/send_webmesg?.target=' . $row['user_yim'] . '&amp;.src=pg">' . $lang['YIM'] . '</a>' : '';

	$temp_url = append_sid(basefile . "page=search&search_author=" . urlencode($username) . "&amp;showresults=posts");
	$search_img = '<a href="' . $temp_url . '"><img src="' . $phpBB2_install_url . $images['icon_search'] . '" alt="' . sprintf($lang['Search_user_posts'], $row['username']) . '" title="' . sprintf($lang['Search_user_posts'], $row['username']) . '" border="0" /></a>';
...
if ( isset($HTTP_POST_VARS['groupstatus']) && $group_id )
{
	if ( !$userdata['session_logged_in'] )
	{
		...
		redirect(append_sid(basefile . "page=login&redirect=" . rawurlencode("" . basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id"), true));
	}
	...
	if ( $row['group_moderator'] != $userdata['user_id'] && $userdata['user_level'] != ADMIN )
	{
		$template->assign_vars(array(
			'META' => '<meta http-equiv="refresh" content="3;url=' . append_sid(basefile . "") . '">')
		);
		...
		$message = $lang['Not_group_moderator'] . '<br /><br />' . sprintf($lang['Click_return_group'], '<a href="' . append_sid(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_index'], '<a href="' . append_sid(basefile . "") . '">', '</a>');
	...
	$template->assign_vars(array(
		'META' => '<meta http-equiv="refresh" content="3;url=' . append_sid(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id") . '">')
	);
	...
	$message = $lang['Group_type_updated'] . '<br /><br />' . sprintf($lang['Click_return_group'], '<a href="' . append_sid(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_index'], '<a href="' . append_sid(basefile . "") . '">', '</a>');
...
else if ( isset($HTTP_POST_VARS['joingroup']) && $group_id )
{
	...
	if (	$row = $db->sql_fetchrow($result) )
	{
		if ( $row['group_type'] == GROUP_OPEN )
		{
			do
			{
				if ( $userdata['user_id'] == $row['user_id'] )
				{
					...
					$message = $lang['Already_member_group'] . '<br /><br />' . sprintf($lang['Click_return_group'], '<a href="' . append_sid(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_index'], '<a href="' . append_sid(basefile . "") . '">', '</a>');
		...
		else
		{
			...
			$message = $lang['This_closed_group'] . '<br /><br />' . sprintf($lang['Click_return_group'], '<a href="' . append_sid(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_index'], '<a href="' . append_sid(basefile . "") . '">', '</a>');
	...
	$message = $lang['Group_joined'] . '<br /><br />' . sprintf($lang['Click_return_group'], '<a href="' . append_sid(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_index'], '<a href="' . append_sid(basefile . "") . '">', '</a>');
...
else if ( isset($HTTP_POST_VARS['unsub']) || isset($HTTP_POST_VARS['unsubpending']) && $group_id )
{
	...
	if ( $cancel )
	{
		...
		redirect(append_sid(relativebasefile . "page=groupcp", true));
	}
	...
	if ( $confirm )
	{
		...
		$message = $lang['Unsub_success'] . '<br /><br />' . sprintf($lang['Click_return_group'], '<a href="' . append_sid(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_index'], '<a href="' . append_sid(basefile . "") . '">', '</a>');
	...
	else
	{
		...
		$template->assign_vars(array(
			...
			'L_YES' => $lang['Yes'],
			'L_NO' => $lang['No'],
			'S_CONFIRM_ACTION' => append_sid(basefile . "page=groupcp"),
...
else if ( $group_id )
{
	...
	if ( $group_info = $db->sql_fetchrow($result) )
	{
		...
		if ( !empty($HTTP_POST_VARS['add']) || !empty($HTTP_POST_VARS['remove']) || isset($HTTP_POST_VARS['approve']) || isset($HTTP_POST_VARS['deny']) )
		{
			...
			if ( !$is_moderator )
			{
				...
				$message = $lang['Not_group_moderator'] . '<br /><br />' . sprintf($lang['Click_return_index'], '<a href="' . append_sid(basefile . "") . '">', '</a>');
			...
			if ( isset($HTTP_POST_VARS['add']) )
			{
				...
				if ( !($row = $db->sql_fetchrow($result)) )
				{
					...
					$message = $lang['Could_not_add_user'] . "<br /><br />" . sprintf($lang['Click_return_group'], "<a href=\"" . append_sid(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id") . "\">", "</a>") . "<br /><br />" . sprintf($lang['Click_return_index'], "<a href=\"" . append_sid(basefile . "") . "\">", "</a>");
				...
				if ( $row['user_id'] == ANONYMOUS )
				{
					...
					$message = $lang['Could_not_anon_user'] . '<br /><br />' . sprintf($lang['Click_return_group'], '<a href="' . append_sid(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_index'], '<a href="' . append_sid(basefile . "") . '">', '</a>');
				...
				if ( !($db->sql_fetchrow($result)) )
				{
  				  ...
  				  $url = $portal_install_url . basefile . 'page=groupcp&' . POST_GROUPS_URL . "=$group_id";
  				}
  				else{
  				  $url = basefile . 'page=groupcp&' . POST_GROUPS_URL . "=$group_id";
  				}		
				...
				else
				{
					...
					$message = $lang['User_is_member_group'] . '<br /><br />' . sprintf($lang['Click_return_group'], '<a href="' . append_sid(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id") . '">', '</a>') . '<br /><br />' . sprintf($lang['Click_return_index'], '<a href="' . append_sid(basefile . "") . '">', '</a>');
	...
	$template->assign_vars(array(
		...
		'U_MOD_VIEWPROFILE' => append_sid(basefile . "page=profile&mode=viewprofile&amp;" . POST_USERS_URL . "=$user_id"), 
		// FIXME: 
		...
		'S_GROUPCP_ACTION' => append_sid(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id"))
	);
	...
	for($i = $start; $i < min($board_config['topics_per_page'] + $start, $members_count); $i++)
	{
		...
		if ( $group_info['group_type'] != GROUP_HIDDEN || $is_group_member || $is_moderator )
		{
			...
			$template->assign_block_vars('member_row', array(
				...
				'U_VIEWPROFILE' => append_sid(basefile . "page=profile&mode=viewprofile&amp;" . POST_USERS_URL . "=$user_id"))
			);
	...
	$template->assign_vars(array(
		...
		'PAGINATION' => generate_pagination(basefile . "page=groupcp&" . POST_GROUPS_URL . "=$group_id", $members_count, $board_config['topics_per_page'], $start),
...
else
{
	...
	if ( $s_group_list_opt != '' || $s_pending_groups_opt != '' || $s_member_groups_opt != '' )
	{
		...
		$template->assign_vars(array(
			...
			//'S_HIDDEN_FIELDS' => $s_hidden_fields, 
			//FIXME:
			//'S_USERGROUP_ACTION' => append_sid(basefile . "page=groupcp&"), 
			'S_USERGROUP_ACTION' => append_sid(basefile), 
			//'S_HIDDEN_FIELDS' => $s_hidden_fields, 
			'S_HIDDEN_FIELDS' => '<input type="hidden" name="option" value="com_forum"><input type="hidden" name="page" value="groupcp">',
