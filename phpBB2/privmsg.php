...
if ( $cancel )
{
	...
	redirect(append_sid(relativebasefile . "page=privmsg&folder=$folder", true));
}
...
$inbox_img = ( $folder != 'inbox' || $mode != '' ) ? '<a href="' . append_sid(basefile . "page=privmsg&folder=inbox") . '"><img src="' . $phpBB2_install_url . $images['pm_inbox'] . '" border="0" alt="' . $lang['Inbox'] . '" /></a>' : '<img src="' . $phpBB2_install_url . $images['pm_inbox'] . '" border="0" alt="' . $lang['Inbox'] . '" />';
//$inbox_url = ( $folder != 'inbox' || $mode != '' ) ? '<a href="' . append_sid("privmsg.$phpEx?folder=inbox") . '">' . $lang['Inbox'] . '</a>' : $lang['Inbox'];
$inbox_url = ( $folder != 'inbox' || $mode != '' ) ? '<a href="' . append_sid(basefile . "page=privmsg&folder=inbox") . '">' . $lang['Inbox'] . '</a>' : $lang['Inbox'];
...
$outbox_img = ( $folder != 'outbox' || $mode != '' ) ? '<a href="' . append_sid(basefile . "page=privmsg&folder=outbox") . '"><img src="' . $phpBB2_install_url . $images['pm_outbox'] . '" border="0" alt="' . $lang['Outbox'] . '" /></a>' : '<img src="' . $phpBB2_install_url . $images['pm_outbox'] . '" border="0" alt="' . $lang['Outbox'] . '" />';
//$outbox_url = ( $folder != 'outbox' || $mode != '' ) ? '<a href="' . append_sid("privmsg.$phpEx?folder=outbox") . '">' . $lang['Outbox'] . '</a>' : $lang['Outbox'];
$outbox_url = ( $folder != 'outbox' || $mode != '' ) ? '<a href="' . append_sid(basefile . "page=privmsg&folder=outbox") . '">' . $lang['Outbox'] . '</a>' : $lang['Outbox'];
...
$sentbox_img = ( $folder != 'sentbox' || $mode != '' ) ? '<a href="' . append_sid(basefile . "page=privmsg&folder=sentbox") . '"><img src="' . $phpBB2_install_url . $images['pm_sentbox'] . '" border="0" alt="' . $lang['Sentbox'] . '" /></a>' : '<img src="' . $phpBB2_install_url . $images['pm_sentbox'] . '" border="0" alt="' . $lang['Sentbox'] . '" />';
//$sentbox_url = ( $folder != 'sentbox' || $mode != '' ) ? '<a href="' . append_sid("privmsg.$phpEx?folder=sentbox") . '">' . $lang['Sentbox'] . '</a>' : $lang['Sentbox'];
$sentbox_url = ( $folder != 'sentbox' || $mode != '' ) ? '<a href="' . append_sid(basefile . "page=privmsg&folder=sentbox") . '">' . $lang['Sentbox'] . '</a>' : $lang['Sentbox'];
...
$savebox_img = ( $folder != 'savebox' || $mode != '' ) ? '<a href="' . append_sid(basefile . "page=privmsg&folder=savebox") . '"><img src="' . $phpBB2_install_url . $images['pm_savebox'] . '" border="0" alt="' . $lang['Savebox'] . '" /></a>' : '<img src="' . $phpBB2_install_url . $images['pm_savebox'] . '" border="0" alt="' . $lang['Savebox'] . '" />';
//$savebox_url = ( $folder != 'savebox' || $mode != '' ) ? '<a href="' . append_sid("privmsg.$phpEx?folder=savebox") . '">' . $lang['Savebox'] . '</a>' : $lang['Savebox'];
$savebox_url = ( $folder != 'savebox' || $mode != '' ) ? '<a href="' . append_sid(basefile . "page=privmsg&folder=savebox") . '">' . $lang['Savebox'] . '</a>' : $lang['Savebox'];
...
if ( $mode == 'newpm' )
{
	...
	if ( $userdata['session_logged_in'] )
	{
		...
		$l_new_message .= '<br /><br />' . sprintf($lang['Click_view_privmsg'], '<a href="' . append_sid(basefile . "page=privmsg&folder=inbox") . '" onclick="jump_to_inbox();return false;" target="_new">', '</a>');
	}
	else
	{
...
else if ( $mode == 'read' )
{
	...
	if ( !$userdata['session_logged_in'] )
	{
		...
		redirect(append_sid(relativebasefile . "page=login&redirect=" . rawurlencode(relativebasefile . "page=privmsg&folder=$folder&mode=$mode&" . POST_POST_URL . "=$privmsgs_id"), true));
	}
	...
	{
		//redirect(append_sid("privmsg.$phpEx?folder=$folder", true));
		redirect(append_sid(basefile . "page=privmsg&folder=$folder", true));
	}
	...
	$post_urls = array(
		...
		'post' => append_sid(basefile . "page=privmsg&mode=post"),
		//'reply' => append_sid("privmsg.$phpEx?mode=reply&amp;" . POST_POST_URL . "=$privmsg_id"),
		'reply' => append_sid(basefile . "page=privmsg&mode=reply&amp;" . POST_POST_URL . "=$privmsg_id"),
		//'quote' => append_sid("privmsg.$phpEx?mode=quote&amp;" . POST_POST_URL . "=$privmsg_id"),
		'quote' => append_sid(basefile . "page=privmsg&mode=quote&amp;" . POST_POST_URL . "=$privmsg_id"),		
		//'edit' => append_sid("privmsg.$phpEx?mode=edit&amp;" . POST_POST_URL . "=$privmsg_id")
		'edit' => append_sid(basefile . "page=privmsg&mode=edit&amp;" . POST_POST_URL . "=$privmsg_id")
	);
	$post_icons = array(
		'post_img' => '<a href="' . $post_urls['post'] . '"><img src="' . $phpBB2_install_url . $images['pm_postmsg'] . '" alt="' . $lang['Post_new_pm'] . '" border="0" /></a>',
		'post' => '<a href="' . $post_urls['post'] . '">' . $lang['Post_new_pm'] . '</a>',
		'reply_img' => '<a href="' . $post_urls['reply'] . '"><img src="' . $phpBB2_install_url . $images['pm_replymsg'] . '" alt="' . $lang['Post_reply_pm'] . '" border="0" /></a>',
		'reply' => '<a href="' . $post_urls['reply'] . '">' . $lang['Post_reply_pm'] . '</a>',
		'quote_img' => '<a href="' . $post_urls['quote'] . '"><img src="' . $phpBB2_install_url . $images['pm_quotemsg'] . '" alt="' . $lang['Post_quote_pm'] . '" border="0" /></a>',
		'quote' => '<a href="' . $post_urls['quote'] . '">' . $lang['Post_quote_pm'] . '</a>',
		'edit_img' => '<a href="' . $post_urls['edit'] . '"><img src="' . $phpBB2_install_url . $images['pm_editmsg'] . '" alt="' . $lang['Edit_pm'] . '" border="0" /></a>',
	...
	make_jumpbox(basefile . 'page=viewforum');
	...
	$template->assign_vars(array(
		...
		'S_PRIVMSGS_ACTION' => append_sid(basefile . "page=privmsg&folder=$folder"),
	...
	$temp_url = append_sid(basefile . "page=profile&mode=viewprofile&amp;" . POST_USERS_URL . '=' . $user_id_from);
	...
	if ( !empty($privmsg['user_viewemail']) || $userdata['user_level'] == ADMIN )
	{
		...
		$email_uri = ( $board_config['board_email_form'] ) ? append_sid(basefile . "page=profile&mode=email&amp;" . POST_USERS_URL .'=' . $user_id_from) : 'mailto:' . $privmsg['user_email'];
	...
	$www_img = ( $privmsg['user_website'] ) ? '<a href="' . $privmsg['user_website'] . '" target="_userwww"><img src="' . $phpBB2_install_url . $images['icon_www'] . '" alt="' . $lang['Visit_website'] . '" title="' . $lang['Visit_website'] . '" border="0" /></a>' : '';
	...
	if ( !empty($privmsg['user_icq']) )
	{
		...
		$icq_img = '<a href="http://wwp.icq.com/scripts/search.dll?to=' . $privmsg['user_icq'] . '"><img src="' . $phpBB2_install_url . $images['icon_icq'] . '" alt="' . $lang['ICQ'] . '" title="' . $lang['ICQ'] . '" border="0" /></a>';
	...
	$aim_img = ( $privmsg['user_aim'] ) ? '<a href="aim:goim?screenname=' . $privmsg['user_aim'] . '&amp;message=Hello+Are+you+there?"><img src="' . $phpBB2_install_url . $images['icon_aim'] . '" alt="' . $lang['AIM'] . '" title="' . $lang['AIM'] . '" border="0" /></a>' : '';
	$aim = ( $privmsg['user_aim'] ) ? '<a href="aim:goim?screenname=' . $privmsg['user_aim'] . '&amp;message=Hello+Are+you+there?">' . $lang['AIM'] . '</a>' : '';

	//$temp_url = append_sid("profile.$phpEx?mode=viewprofile&amp;" . POST_USERS_URL . "=$user_id_from");
	$temp_url = append_sid(basefile . "page=profile&mode=viewprofile&amp;" . POST_USERS_URL . "=$user_id_from");
	$msn_img = ( $privmsg['user_msnm'] ) ? '<a href="' . $temp_url . '"><img src="' . $phpBB2_install_url . $images['icon_msnm'] . '" alt="' . $lang['MSNM'] . '" title="' . $lang['MSNM'] . '" border="0" /></a>' : '';
	$msn = ( $privmsg['user_msnm'] ) ? '<a href="' . $temp_url . '">' . $lang['MSNM'] . '</a>' : '';

	$yim_img = ( $privmsg['user_yim'] ) ? '<a href="http://edit.yahoo.com/config/send_webmesg?.target=' . $privmsg['user_yim'] . '&amp;.src=pg"><img src="' . $phpBB2_install_url . $images['icon_yim'] . '" alt="' . $lang['YIM'] . '" title="' . $lang['YIM'] . '" border="0" /></a>' : '';
	...
	$temp_url = append_sid(basefile . "page=search&search_author=" . urlencode($username_from) . "&amp;showresults=posts");
	$search_img = '<a href="' . $temp_url . '"><img src="' . $phpBB2_install_url . $images['icon_search'] . '" alt="' . sprintf($lang['Search_user_posts'], $username_from) . '" title="' . sprintf($lang['Search_user_posts'], $username_from) . '" border="0" /></a>';
...
else if ( ( $delete && $mark_list ) || $delete_all )
{
	if ( !$userdata['session_logged_in'] )
	{
		...
		redirect(append_sid(relativebasefile . "page=login&redirect=" . rawurlencode(relativebasefile . "page=privmsg&folder=inbox"), true));
	}
	...
	if ( !$confirm )
	{
		...
		$template->assign_vars(array(
			...
			'S_CONFIRM_ACTION' => append_sid(basefile . "page=privmsg&folder=$folder"),
			'S_HIDDEN_FIELDS' => $s_hidden_fields)
		);
...
else if ( $save && $mark_list && $folder != 'savebox' && $folder != 'outbox' )
{
	...
	if (sizeof($mark_list))
	{
		...
		redirect(append_sid(relativebasefile . "page=privmsg&folder=savebox", true));
	}
}
else if ( $submit || $refresh || $mode != '' )
{
	if ( !$userdata['session_logged_in'] )
	{
		...
		redirect(append_sid(relativebasefile . "page=login&redirect=" . rawurlencode(relativebasefile . "page=privmsg&folder=$folder&mode=$mode" . $user_id), true));
	}
	...
	if ( $submit && !$error )
	{
		...
		if ( $mode != 'edit' )
		{
			...
			if ( $to_userdata['user_notify_pm'] && !empty($to_userdata['user_email']) && $to_userdata['user_active'] )
			{
				...
				if(substr(basefile, 0, 4) != "http"){
				  $url = $portal_install_url . basefile . 'page=privmsg&folder=inbox';
				}
				else{
				  $url = basefile . 'page=privmsg&folder=inbox';
				}
		...
		$template->assign_vars(array(
			...
			'META' => '<meta http-equiv="refresh" content="3;url=' . append_sid(basefile . "page=privmsg&folder=inbox") . '">')
		);
		...
		$msg = $lang['Message_sent'] . '<br /><br />' . sprintf($lang['Click_return_inbox'], '<a href="' . append_sid(basefile . "page=privmsg&folder=inbox") . '">', '</a> ') . '<br /><br />' . sprintf($lang['Click_return_index'], '<a href="' . append_sid(basefile) . '">', '</a>');
	...
	$template->assign_vars(array(
		...
		'BBCODE_STATUS' => sprintf($bbcode_status, '<a href="' . append_sid(basefile . "page=faq&mode=bbcode") . '" target="_phpbbcode">', '</a>'), 
		...
		'S_POST_ACTION' => append_sid(basefile . "page=privmsg"),
			
		//FIXME:
		//'U_SEARCH_USER' => append_sid("search.$phpEx?mode=searchuser"), 
		'U_SEARCH_USER' => append_sid(str_replace("index.php", "index2.php", basefile) . "page=search&mode=searchuser"), 
		//'U_VIEW_FORUM' => append_sid("privmsg.$phpEx"))
		'U_VIEW_FORUM' => append_sid(basefile . "page=privmsg"))
	);
...
$post_new_mesg_url = '<a href="' . append_sid(basefile . "page=privmsg&mode=post") . '"><img src="' . $phpBB2_install_url . $images['post_new'] . '" alt="' . $lang['Send_a_new_message'] . '" border="0" /></a>';
...
$post_pm = append_sid(basefile . "page=privmsg&mode=post");
$post_pm_img = '<a href="' . $post_pm . '"><img src="' . $phpBB2_install_url . $images['pm_postmsg'] . '" alt="' . $lang['Post_new_pm'] . '" border="0" /></a>';
...
$template->assign_vars(array(
	...
	'U_POST_NEW_TOPIC' => append_sid(basefile . "page=privmsg&mode=post"))
);
...
if ( $row = $db->sql_fetchrow($result) )
{
	...
	do
	{
		...
		$u_from_user_profile = append_sid(basefile . "page=profile&mode=viewprofile&amp;" . POST_USERS_URL . "=$msg_userid");
		...
		$u_subject = append_sid(basefile . "page=privmsg&folder=$folder&amp;mode=read&amp;" . POST_POST_URL . "=$privmsg_id");
	...
	$template->assign_vars(array(
		...
		'PAGINATION' => generate_pagination(basefile . "page=privmsg&folder=$folder", $pm_total, $board_config['topics_per_page'], $start),
