...
else
{
  ...
  (You will have to reply to a confirmation email.)</p>
	...
	<? begin_frame("Recover user name or password",false,10,false); 
		 begin_table(true);
	?>
	<tr><td class="row2">Registered email</td>
	<td class="row1"><input type="text" size="40" name="email" /></td></tr>
	<tr><td colspan="2" class="row1" align="center"><input type="submit" value="Do it!" /></td></tr>
	<? end_table();
	end_frame();?>
	</form>
	<?
